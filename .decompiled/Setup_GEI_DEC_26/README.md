# Setup_GEI_DEC_26 Static Decompilation Notes

## What This File Is

- Input: `C:/Users/User/Desktop/Config/Setup_GEI_DEC_26.exe`
- Size: `106,496` bytes
- SHA256: `89EF6BE4DD80F3B2D5E936856C8170CE3B71F3E61A560E2B9A47314FBF1CBE95`
- Detected as: **VB6 native executable / setup utility**, not .NET.
- Important consequence: original `.frm/.bas/.vbp` source cannot be fully reconstructed with normal .NET decompilers. The usable output is metadata, strings, SQL/config clues, table names, and runtime dependencies.

## Useful For G-HUB

1. **Database/config migration map**: DSN, SQL Server connection keys, company config keys, and old paths.
2. **Legacy table inventory**: table/field names such as `CompanyList`, `DocType`, `BonusCom`, `BonusComAgent`, `POSMain`, `Positem`, `zicmast`, `zICGroup`, `CardType`.
3. **Business rule clues**: strings show logic around company list, commission/job code, POS rate group correction, document type column checks, and bonus commission cleanup.
4. **Legacy runtime/dependency list**: VB6 runtime, ADO data control, MSCOMCTL progress bar, WinSock/ICMP/WinAPI usage.
5. **Operational settings**: old config files and folders: `Company.ini`, `Company.cfg`, `System.cfg`, `SysPa.cfg`, `Start.Mnu`, `PRG`, `RPT`, `PICTURE`, `Image`, `C:/AC_Data/Config`.

## Not Useful As Direct Source Code

- This is not a recoverable modern source tree like C#/.NET.
- Function bodies/event handlers are compiled VB6 native code; without a dedicated VB6 native decompiler, recovered logic will be incomplete and should be treated as reference only.
- Do not copy secrets/connection strings into G-HUB. Treat `PWD`, `UID=sa`, server names, and IP-like strings as sensitive migration references.
...
- `DATABASE =`
- `PWD=`
- `; database=AC_Dat1; UID=sa; PWD=`
- `SQLCONNECT2`
- `Select @@ServerName as ServerName `
- `ServerName`
- `pwd=`
- `; database=Master;  `
- `Driver={SQL Server}; Server=(Local); database=Master;  `
- `; database=`
- `; UID=`
- `; PWD=`
- `Select @@ServerName as ServerName`
...
- `Image\`
- `SysPa.cfg`
- `C:\AC_Data\Config\System.`
- `C:\AC_Data\Config\System.cfg`
- `Start.Mnu`
- `System.cfg`
...
- `commission`
- `select isnull(company_name,'') as companyname,isnull(POS,'N') as POS,isnull(commission,'') as commission ,isnull(jobcode,'') as jobcode from companylist where convert(varchar,company_code)=convert(varchar,'`
- ` and  b.product = a.product_code  and d.Bonus='`
- `' and d.AgentCom='Y' `
- `update positem set rategroup='`
- `rategroup`
- ` and product='`
...
- ` and Posmain.Bonus='`
- `' Order by Positem.RateGroup`
- `' and Bonus.Tour *= TourGroup.Code and Bonus.Nation*=TourGroup.Nation_Code and TourGroup.RateGroup='`
- `Select Sum(Amount) as Amount from PosItem  Where Date=`
- `Select * from BonusComAgent Where Date=`
- `'  and RateGroup='`
- ` select isnull(sum(net),0) as saleamount from posmain where bonus='`
...
- ` Select  a.Code as BillCode,b.Quantity as Qty,a.Discount as Discount1,b.RateGroup,a.DiscPct,b.TourPercent,b.GuidePercent,a.Total,b.Amount,b.Discount,a.Card,a.CardExchg,a.PrepaidCash,a.PrepaidCard,a.PrepaidCashExchg,a.PrepaidCardExchg,a.Credit,a.BankFee,a.BankFee_Prepaid,b.FixCost_Unit,b.Number,a.Currency,a.Rate,b.MainDiscount  from PosmainH a,PositemH b where a.date=b.date and  a.code = b.code and a.date=`
- `Select sum(Card+CardExchg) as Card  from Posmain a Where Exists (Select  Posmain.Date,Posmain.Code from Posmain,Positem,Product where Positem.Product *=Product.Code and Posmain.date=Positem.date and  Posmain.code = Positem.code and Posmain.date='`
- `' and posmain.date=a.date and posmain.code=a.code ) `
- `Update BonusCom Set GuideAmount=0,GuidepieceAmount=0,GAmount=0,GPiece=0,Gtotal=0  Where Date=`
- `(Select  b.GuideComPct,a.Code as BillCode,b.Quantity as Qty,a.Discount as Discount1,b.RateGroup,a.DiscPct,b.TourPercent,b.GuidePercent,a.Total,b.Amount,b.Discount,a.Card,a.CardExchg,a.PrepaidCash,a.PrepaidCard,a.PrepaidCashExchg,a.PrepaidCardExchg,a.Credit,a.BankFee,a.BankFee_Prepaid,b.FixCost_Unit,b.Number,a.Currency,a.Rate,b.MainDiscount  from Posmain a,Positem b where a.date=b.date and  a.code = b.code and a.date=`
- ` Select  b.GuideComPct,a.Code as BillCode,b.Quantity as Qty,a.Discount as Discount1,b.RateGroup,a.DiscPct,b.TourPercent,b.GuidePercent,a.Total,b.Amount,b.Discount,a.Card,a.CardExchg,a.PrepaidCash,a.PrepaidCard,a.PrepaidCashExchg,a.PrepaidCardExchg,a.Credit,a.BankFee,a.BankFee_Prepaid,b.FixCost_Unit,b.Number,a.Currency,a.Rate,b.MainDiscount  from PosmainH a,PositemH b where a.date=b.date and  a.code = b.code and a.date=`
- ` Order by b.RateGroup,b.GuideComPct `
...
- `metadata.json` - file hash, PE info, string counts
- `pe_sections.json` - PE section inventory
- `categorized_strings.json` - strings grouped by migration usefulness
- `sql_strings.sql` - SQL-like snippets extracted as comments
- `raw/strings_ascii.txt`, `raw/strings_utf16.txt`, `raw/strings_all.txt` - raw extracted strings