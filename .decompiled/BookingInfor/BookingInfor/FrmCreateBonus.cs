...
public class FrmCreateBonus : RibbonForm
{
	...
	private void btnClearBonusCode_ItemClick(object sender, ItemClickEventArgs e)
	{
		...
		for (int i = 0; i < gridView1.SelectedRowsCount; i++)
		{
			...
			DateTime dateTime = Convert.ToDateTime(dataRow["DateBookJW"]);
			string text = dataRow["Bonus_Ref"].ToString();
			if (DataSQL.IsUploadDataToBonusList(docNo))
			{
				MessageBox.Show("bonus card :" + text + " ม\u0e35การ Upload แล\u0e49ว ไม\u0e48สามารถเคล\u0e35ยร\u0e4cได\u0e49");
			}
			else
			{
	...
	private void btnUpLoad_ItemClick(object sender, ItemClickEventArgs e)
	{
		...
		DialogResult dialogResult = MessageBox.Show("Do you want to upload to bonus ?", "Comfirm upload", MessageBoxButtons.YesNo);
		if (dialogResult == DialogResult.No)
		{
			return;
		}
		...
		for (int i = 0; i < gridView1.SelectedRowsCount; i++)
		{
			...
			else
			{
				if (DataSQL.IsHasBonusCodeInTableBonus(bonusDate, text4))
				{
					MessageBox.Show("bonus card :" + text4 + " ม\u0e35การสร\u0e49างใน Bonus แล\u0e49ว ไม\u0e48สามารถ upload ได\u0e49", "แจ\u0e49งเต\u0e37อน", MessageBoxButtons.OK, MessageBoxIcon.Hand);
					return;
				}
				DataSQL.InsertDataToTableBonus(dataRow);
			}
		}
		CloseWaitForm();
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(BookingInfor.FrmCreateBonus));
		...
		this.ribbon.Items.AddRange(new DevExpress.XtraBars.BarItem[8]
		{
		...
		this.ribbon.Size = new System.Drawing.Size(1104, 147);
		this.ribbon.StatusBar = this.ribbonStatusBar;
		this.ribbon.Toolbar.ShowCustomizeItem = false;
		this.beiDate.Caption = "Book Date";
		...
		this.btnUpLoad.Caption = "Upload to Bonus";
		...
		this.ribbonPage1.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[5] { this.ribbonPageGroup1, this.ribbonPageGroup2, this.ribbonPageGroup3, this.ribbonPageGroup4, this.ribbonPageGroup5 });
		this.ribbonPage1.Name = "ribbonPage1";
		this.ribbonPage1.Text = "Home";
		this.ribbonPageGroup1.ItemLinks.Add(this.beiDate);
		this.ribbonPageGroup1.Name = "ribbonPageGroup1";
		this.ribbonPageGroup1.ShowCaptionButton = false;
		this.ribbonPageGroup1.Text = "Date";
		this.ribbonPageGroup2.ItemLinks.Add(this.btnGenBonusAuto);
		this.ribbonPageGroup2.ItemLinks.Add(this.btnGenBonusManual);
		this.ribbonPageGroup2.ItemLinks.Add(this.btnClearBonusCode);
		this.ribbonPageGroup2.Name = "ribbonPageGroup2";
		this.ribbonPageGroup2.ShowCaptionButton = false;
		this.ribbonPageGroup2.Text = "Generate Bonus";
		this.ribbonPageGroup3.ItemLinks.Add(this.btnUpLoad);
		this.ribbonPageGroup3.Name = "ribbonPageGroup3";
		this.ribbonPageGroup3.ShowCaptionButton = false;
		this.ribbonPageGroup3.Text = "Controller";
		...
		this.ribbonStatusBar.Size = new System.Drawing.Size(1104, 23);
		...
		this.gridControl1.Size = new System.Drawing.Size(1104, 279);
		...
		base.ClientSize = new System.Drawing.Size(1104, 449);
		base.Controls.Add(this.gridControl1);
		base.Controls.Add(this.ribbonStatusBar);
		base.Controls.Add(this.ribbon);
		base.Icon = (System.Drawing.Icon)resources.GetObject("$this.Icon");
		base.Name = "FrmCreateBonus";
		this.Ribbon = this.ribbon;
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.StatusBar = this.ribbonStatusBar;
		this.Text = "Gen. Bonus Code and Create To Bonus";
